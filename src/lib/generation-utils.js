...
const PRESET_PROMPTS = {
  ...
  "character-walk-8dir": "8-direction walk sprite sheet, rows are facing directions (down, down-left, left, up-left, up, up-right, right, down-right) and columns are walk-cycle frames; same character in every cell; equal-width cells; consistent scale; no labels",
