...
const SUBJECTS = [
  { id: "xianxia-sword-hero", assetType: "character", style: "production", camera: "front",
    brief: "仙侠风青衫剑客，御剑而立，鎏金衣纹，半身立绘", derive: ["3d", "actions"] },
  { id: "cyberpunk-runner", assetType: "character", style: "anime", camera: "front",
    brief: "赛博朋克都市夜行者，霓虹外套，机械义肢，全身像", derive: ["actions"] },
  { id: "pixel-knight", assetType: "character", style: "pixel-art", camera: "front",
    brief: "像素骑士，银甲红披风，侧身行走姿态", derive: ["video"] },
  { id: "fantasy-beast", assetType: "creature", style: "production", camera: "front",
    brief: "西幻巨狼魔兽，幽蓝鬃毛，獠牙，战斗姿态", derive: ["3d", "actions", "layers"] },
  { id: "scifi-drone", assetType: "creature", style: "isometric", camera: "isometric",
    brief: "科幻悬浮侦察无人机，钢蓝装甲，发光传感器", derive: ["3d"] },
  { id: "jade-blade", assetType: "weapon", style: "production", camera: "front",
    brief: "玉骨长剑，半透碧玉剑身，鎏金护手，道具图标", derive: ["3d"] },
  { id: "spirit-gem", assetType: "prop", style: "production", camera: "front",
    brief: "灵石宝珠，多面切割，内蕴流光，透明背景道具", derive: [] },
  { id: "skill-vfx-burst", assetType: "vfx", style: "anime", camera: "front",
    brief: "技能特效，金色爆发冲击波，四帧序列", derive: [] },
  { id: "ui-hud-frame", assetType: "ui", style: "production", camera: "front",
    brief: "现代游戏 HUD 边框组件，深色玻璃拟态，鎏金描边", derive: [] },
  { id: "forest-tile", assetType: "map", style: "production", camera: "top-down",
    brief: "俯视森林地表瓦片，可平铺草地与石径", derive: [] },
  { id: "icon-set-portal", assetType: "icon", style: "production", camera: "front",
    brief: "传送阵法图标，青金灵光圆形徽记", derive: [] },
];
